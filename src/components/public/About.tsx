  ...
  return (
    <section id="about" className="py-24 bg-brand-sand-100 bg-gold-glow border-b border-brand-sand-300">
      <div className="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="bg-brand-sand-200 text-brand-sand-900 rounded-[3rem] p-10 sm:p-16 lg:p-20 shadow-xl hover:shadow-[0_0_45px_rgba(212,175,55,0.06)] relative overflow-hidden border border-brand-gold-500/10 transition-all duration-500">
          ...
          <div className="relative z-10 grid grid-cols-1 lg:grid-cols-3 gap-8 items-start">
            ...
            <div className="lg:col-span-1">
              ...
              <h2 className="text-4xl sm:text-5xl font-black font-display tracking-tight text-gold-texture leading-tight uppercase">
                {heading || 'About Us'}
              </h2>
